...
if not isfile(Library.Folder .. "hue.jpg") then
	writefile(Library.Folder .. "hue.jpg", game:HttpGet("https://github.com/s0opdev/pasta/blob/main/hue.png?raw=true"))
end
if not isfile(Library.Folder .. "sat.jpg") then
	writefile(Library.Folder .. "sat.jpg", game:HttpGet("https://github.com/s0opdev/pasta/blob/main/sat.png?raw=true"))
end
if not isfile(Library.Folder .. "val.jpg") then
	writefile(Library.Folder .. "val.jpg", game:HttpGet("https://github.com/s0opdev/pasta/blob/main/val.png?raw=true"))
end
if not isfile(Library.Folder .. "cursor.jpg") then
	writefile(Library.Folder .. "cursor.jpg", game:HttpGet("https://github.com/s0opdev/pasta/blob/main/cursor.png?raw=true"))
end
if not isfile(Library.Folder .. "highlight.jpg") then
	writefile(Library.Folder .. "highlight.jpg", game:HttpGet("https://github.com/s0opdev/pasta/blob/main/highlight.png?raw=true"))
end
writefile(Library.Folder .. "ProggyClean.ttf", game:HttpGet("https://github.com/s0opdev/pasta/raw/refs/heads/main/ProggyClean.ttf"))
...
function Library:Window(Options)
	...
	local DragButton = Library:Create('TextButton', {
		...
		BorderSizePixel = 0,
		BorderColor3 = Color3.new(0, 0, 0),
		Text = "Rise | " .. game:GetService("MarketplaceService"):GetProductInfo(game.PlaceId).Name,
		TextColor3 = "Accent",
		AutoButtonColor = false,
		FontFace = Library.Font,
		TextSize = Library.FontSize,
