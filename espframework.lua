...
local ESP; ESP = {
    Settings = {
        ...
        Armorbar = {Enabled = false, Position = "Right", Color = Color3.new(1, 1, 1), Color_Lerp = Color3.fromRGB(0, 136, 194)},
...
do -- Player Metatable
    ...
    function Player_Metatable:Update()
        ...
        if Character ~= nil then
            ...
            local Current_Armor, Armor_Maximum = ESP:Get_Armor(self.Player), 125
            if Head and HumanoidRootPart and Current_Health > 0 then
                ...
                if ESP.Settings.Enabled and On_Screen and Meter_Distance < ESP.Settings.Maximal_Distance and Good then
                    ...
                    local Armor_Top_Size_Outline = Vector2.new(Box_Size.X - 4, 3)
                    local Armor_Top_Pos_Outline = Box_Position + Vector2.new(2, Box_Size.Y - 6)
                    local Armor_Top_Size_Fill = Vector2.new((Current_Armor * Armor_Top_Size_Outline.X / Armor_Maximum) + 2, 1)
                    local Armor_Top_Pos_Fill = Armor_Top_Pos_Outline + Vector2.new(1 + -(Armor_Top_Size_Fill.X - Armor_Top_Size_Outline.X),1);
                    ...
                    Armorbar.Visible = Armorbar_Enabled
                    Armorbar_Outline.Visible = Armorbar_Enabled
